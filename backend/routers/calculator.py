...
def multiplicate(request: OperationRequest, 
    ...
    result = calculator_service.multiplicate(user_id, request.operand1, request.operand2)
    return {"result": result}
...
def exponentiate(request: OperationRequest, 
    ...
    result = calculator_service.exponentiate(user_id, request.operand1, request.operand2)
    return {"result": result}
